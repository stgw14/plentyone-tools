...
async function handleToolCall(name, args) {
    ...
    switch (name) {
            ...
            if (!username || !password) {
                result = {
                    ...
                    error: {
                        ...
                        message: "Username and password are required. Provide them as arguments or set PLENTYONE_USERNAME and PLENTYONE_PASSWORD environment variables.",
                    },
                };
                break;
            }
            if (!config.baseUrl) {
                result = {
                    ...
                    error: {
                        ...
                        message: "Base URL is required. Set PLENTYONE_BASE_URL environment variable.",
                    },
                };
                break;
            }
            result = await makeRequest("/rest/login", {
                method: "POST",
        ...
        case "plenty_get_contact_addresses": {
            const contactId = args.contactId;
            result = await makeRequest(`/rest/accounts/contacts/${contactId}/addresses`);
            break;
        }
        ...
        case "plenty_get_variation": {
            ...
            result = await makeRequest(`/rest/items/${itemId}/variations/${variationId}`, {
                query: {
                    with: args.with,
                    lang: args.lang,
                },
        ...
        case "plenty_get_warehouse_stock": {
            ...
            result = await makeRequest(`/rest/stockmanagement/warehouses/${warehouseId}/stock`, {
                query: {
                    page: args.page,
                    itemsPerPage: args.itemsPerPage,
                    updatedAtFrom: args.updatedAtFrom,
        ...
        case "plenty_get_warehouse": {
            const warehouseId = args.warehouseId;
            result = await makeRequest(`/rest/stockmanagement/warehouses/${warehouseId}`);
            break;
        }
        case "plenty_list_warehouse_locations": {
            const warehouseId = args.warehouseId;
            result = await makeRequest(`/rest/stockmanagement/warehouses/${warehouseId}/locations`);
            break;
        }
