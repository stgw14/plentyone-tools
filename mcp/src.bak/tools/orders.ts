...
export const ordersTools: Tool[] = [
    ...
    inputSchema: {
      ...
      properties: {
        ...
        with: {
          type: "string",
          description:
            "Include related data (comma-separated, e.g., 'addresses,orderItems,documents')",
        },
        statusFrom: {
          type: "number",
  ...
  },
  {
    ...
    description:
      "Get all addresses of a specific order (billing, delivery, etc.).",
    inputSchema: {
      type: "object",
      properties: {
        orderId: {
  ...
  },
  {
    ...
    description:
      "Get all documents of a specific order (invoices, delivery notes, etc.).",
    inputSchema: {
      type: "object",
      properties: {
        orderId: {
